function(setup)
  {
    ...
    env: {
      ...
      'lti1p3-gateway': {
        APP_ENV: 'dev',
        APP_SECRET: setup.lib.hash('proctoring/env/APP_SECRET'),
        CORS_ALLOW_ORIGIN: '*',
        DYNAMIC_API_URL: setup.apps.dynamic_query.api.http.url,
        LTI1P3_SERVICE_ENCRYPTION_KEY: setup.lib.hash('proctoring/env/LTI1P3_SERVICE_ENCRYPTION_KEY'),
        // AUTOMATIC_AUTHORIZATION: '',
        OAUTH2_PUBLIC_KEY_PATH: '%s/proctoring.pub' % setup.dirs.keys,
        OAUTH2_PRIVATE_KEY_PATH: '%s/proctoring.key' % setup.dirs.keys,
        ...
        ACS_FEATURE: 'true',
        ACS_REGISTRATION: 'lti-deliver-proctoring',
