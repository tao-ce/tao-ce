function(setup)
{
  ...
  "static_resources": {
    ...
    //     "load_assignment": {
    //       "cluster_name": "nextgen_tao_payments_be_cluster",
    //       "endpoints": [
    //         {
    //           "lb_endpoints": [
    //             {
    ...
    //                 "address": {
    //                   "socket_address": {
    //                     "address": "tao-ce-tao-payments-be",
    //                     "port_value": 3000
    //                   }
    //                 }
    //               }
    ...
    //       ]
    //     },
    //     "name": "nextgen_tao_payments_be_cluster",
    //     "type": "strict_dns"
    //   },
      {
        "connect_timeout": "1s",
    ...
    //     "lb_policy": "round_robin",
    //     "load_assignment": {
    //       "cluster_name": "nextgen_tao_studio_be_cluster",
    //       "endpoints": [
    //         {
    //           "lb_endpoints": [
    //             {
    ...
    //       ]
    //     },
    //     "name": "nextgen_tao_studio_be_cluster",
    //     "type": "strict_dns"
    //   },
    //   {
    //     "connect_timeout": "1s",
    ...
    //                 "address": {
    //                   "socket_address": {
    //                     "address": "tao-ce-tao-scoring-service-be",
    //                     "port_value": 8080
    //                   }
    //                 }
    //               }
    ...
    //                 "address": {
    //                   "socket_address": {
    //                     "address": "tao-ce-tao-manual-scoring-be",
    //                     "port_value": 8080
    //                   }
    //                 }
    //               }
    ...
    //                 "address": {
    //                   "socket_address": {
    //                     "address": "tao-ce-tao-hbl-scoring-engine-be",
    //                     "port_value": 8080
    //                   }
    //                 }
    //               }
    ...
    //                 "address": {
    //                   "socket_address": {
    //                     "address": "tao-ce-proctoring-lti13-gateway",
    //                     "port_value": 8080
    //                   }
    //                 }
    //               }
    ...
    //   },
      {
        ...
        "lb_policy": "round_robin",
        "load_assignment": {
          "cluster_name": "nextgen_tao_simple_reports_be_cluster",
          "endpoints": [
            {
              "lb_endpoints": [
                {
                  "endpoint": {
                    "address": {
                      "socket_address": {
                        "address": setup.apps.simple_reports.backend.http.host,
                        "port_value": setup.apps.simple_reports.backend.http.port,
                      }
                    }
                  }
                }
        ...
        "name": "nextgen_tao_simple_reports_be_cluster",
        "type": "strict_dns"
      },
      {
        "connect_timeout": "1s",
                    ...
                    "virtual_hosts": [
                      {
                        ...
                        //     },
                        //     "route": {
                        //       "cluster": "nextgen_tao_studio_be_cluster",
                        //       "prefix_rewrite": "/"
                        //     }
                        //   },
                        //   {
                        ...
                        //   },
                          {
                            ...
                            "route": {
                              "cluster": "nextgen_tao_simple_reports_be_cluster",
                              "prefix_rewrite": "/"
                            }
                          },
                          {
