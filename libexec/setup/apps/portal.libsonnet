function(setup)
  {
    env: {
      backend: {
        ...
        CONTENT_BANK_AUTHORING_TOOL_LAUNCH_URL_PATH: '/backoffice/taoLti/AuthoringTool/launch',
        ...
        GCP_PUBSUB_GRADER_SCORING_EVENTS_SUBSCRIPTION_NAME: 'grader-scoring-events-portal',
        ...
        GCP_PUBSUB_SESSION_GRADED_TOPIC_NAME: 'session-graded-topic',
        ...
        GCP_PUBSUB_SUBMIT_GRADING_PROJECT_SUBSCRIPTION_NAME: 'submit-grading-project-ds',
        GCP_PUBSUB_SUBMIT_GRADING_PROJECT_TOPIC_NAME: 'submit-grading-project-topic',
        ...
        TOKEN_SIGN_SECRET: setup.lib.hash('portal/env/TOKEN_SIGN_SECRET'),
      ...
      bootstrap: {
        ...
        TASK_ORCHESTRATOR_API_URL: setup.apps.task_orchestrator.backend.http.url,
        TENANTS: std.manifestJsonMinified([
          {
            clientId: 'portal-client-id-1',
            label: 'nextgen-stack',
            subdomain: std.split(setup.publicDomain, '.')[0],
            tenantId: '1',
          },
        ]),
